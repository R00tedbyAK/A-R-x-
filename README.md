...
¡A!rX is a lightweight web application that lets you move visual content between computers, phones, and tablets in seconds. Simply paste (`Ctrl+V`) or drop an image into a room to generate a temporary clipboard space and a unique QR code for instant mobile access.
